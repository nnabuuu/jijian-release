...
**安装(Node ≥ 20):**
```bash
npm i -g https://github.com/nnabuuu/jijian-release/releases/download/jijian-bridge-v0.2.8/kedge-agentic-jijian-bridge-0.2.8.tgz
jijian --version && jijian install && jijian doctor
```
或:`gh release download jijian-bridge-v0.2.8 -R nnabuuu/jijian-release -p '*.tgz' && npm i -g ./kedge-agentic-jijian-bridge-0.2.8.tgz`
